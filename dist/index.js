...
var Channel = function() {
    function t(t, e) {
        this.socket = t, this.channel = e, this.subscribe();
    }
    ...
    function t(t) {
        return this.channels = {}, this.missedPing = 0, this.events = new EventEmitter(), 
        this.useBinary = !1, t.url && "string" == typeof t.url ? (this.options = {
            url: t.url,
    ...
    return t.buffer = function(t) {
        ...
        switch (e["#"][0]) {
          ...
          case "p":
            return t.channels[e["#"][1]] ? t.channels[e["#"][1]].onMessage(e["#"][2]) : null;
        ...
        this.websocket.onopen = function() {
            ...
            "#0" === o) return e.missedPing = 0, e.send("#1", null, "ping");
            try {
                o = JSON.parse(o);
            } catch (t) {
                return logError(t);
